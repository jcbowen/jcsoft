...
(function () {
    ...
    var unwrap = function (data, sourceInput) {
        ...
        return __assign(__assign(__assign(__assign(__assign({}, get('poster'), get('source')), get('altsource')), get('poster')), get('embed')), getDimensions(data, metaData));
    };
    ...
    var register$1 = function (editor) {
        editor.ui.registry.addToggleButton('media2', {
        ...
        editor.ui.registry.addMenuItem('media2', {
            icon: 'embed',
            text: 'Media...',
            onAction: function () {
                editor.execCommand('mceMedia');
    ...
    function Plugin() {
        global.add('media2', function (editor) {
