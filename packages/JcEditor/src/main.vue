...
export default {
    ...
    props: {
        ...
        baseUrl: {
            type: String,
            default: process.env.NODE_ENV === 'development' ? './tinymce' : `./tinymce/`
        },
        disabled: {
            type: Boolean,
            default: false
        ...
        content_css: {
            ...
            default: () => {
                return [
                    `${process.env.NODE_ENV === 'development' ? '/tinymce' : './tinymce/'}/skins/content/default/content.css`
                    // , `${j_global.jc_res}vendor/font-awesome-4.7.0/css/font-awesome.min.css`
                    // , `${j_global.jc_res}vendor/wicon/css/wicon.min.css`
                ];
            }
        },
        color_map: {
